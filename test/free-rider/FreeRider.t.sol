...
import {FreeRiderSaver} from "../../src/free-rider/FreeRiderSaver.sol";
...
contract FreeRiderChallenge is Test {
    ...
    function test_freeRider() public checkSolvedByPlayer {
        FreeRiderSaver saverContract = new FreeRiderSaver(address(uniswapV2Factory), address(marketplace),address(recoveryManager), address(weth), address(nft), player);
        saverContract.save(address(uniswapPair), NFT_PRICE, 0,  abi.encode(0));
    }
